...
public class AlertReceiver extends BroadcastReceiver {
   ...
   public static Vibrator vibrator;
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        String push_id = intent.getStringExtra (CreateTaskActivity.EXTRA_ID);
        //create an object of tasknotification class
        taskNotificationHelper b = new taskNotificationHelper (context);
        NotificationCompat.Builder builder = b.ScheduleNotification(title, description, time,push_id);
    ...
    public static class taskNotificationHelper extends ContextWrapper {
        ...
        public NotificationCompat.Builder ScheduleNotification(String title, String description, String time, String push_id) {
            ...
            Notificationintent.putExtra (EXTRA_ID, push_id);
