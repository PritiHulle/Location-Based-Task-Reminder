...
import com.example.taskmanagerpro.ui.LocationListMain;
import com.example.taskmanagerpro.ui.CreateTaskActivity1;
...
public class ProfileFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        TextView time1_history = v.findViewById(R.id.time1_history);
        TextView time1_complete = v.findViewById(R.id.time1_complete);
        TextView time1_delete = v.findViewById(R.id.time1_delete);
        retrieveinfos ();

        time1.setOnClickListener (v16 -> {

            Intent myintent = new Intent (getActivity (), CreateTaskActivity1.class);
        ...
        time1_history.setOnClickListener (v16 -> {
            ...
            Intent myintent = new Intent (getActivity (), LocationListMain.class);
        ...
        upload.setOnClickListener (v12 -> {
            if (mUpload != null && mUpload.isInProgress ()) {
                Toast.makeText (Objects.requireNonNull (getContext ()), "upload is in progress", Toast.LENGTH_SHORT);
            } else {
