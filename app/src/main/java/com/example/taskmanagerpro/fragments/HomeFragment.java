...
import com.example.taskmanagerpro.ui.ActivityTask;
...
//            startActivityForResult (myintent, ADD_NOTE_REQUEST);
            Intent myintent = new Intent (getActivity (), ActivityTask.class);
            startActivityForResult (myintent, ADD_NOTE_REQUEST);
...
//            }
            ...
            Toast.makeText (Objects.requireNonNull (getContext ()), "Task created", Toast.LENGTH_SHORT).show ();
            EndOfPage.setVisibility (View.VISIBLE);
            ...
            if (id == -1) {
                Toast.makeText (Objects.requireNonNull (getContext ()), "Task can't be updated", Toast.LENGTH_SHORT).show ();
                return;
            }
            String title = data.getStringExtra (CreateTaskActivity.EXTRA_TITLE);
            String Des = data.getStringExtra (CreateTaskActivity.EXTRA_DESC);
            ...
            Toast.makeText (Objects.requireNonNull (getContext ()), "Task updated", Toast.LENGTH_SHORT).show ();
